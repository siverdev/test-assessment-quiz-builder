        ...
        >
            ...
            {questions.map((question, questionIndex) => {
                ...
                return (
                    <div
                        key={question.id}
                        className="border border-gray-200 rounded-xl p-6 space-y-4 bg-gray-50 shadow-sm"
                    >
                        {/* Question Text */}
                        <div className="flex flex-col">
            ...
            <div className="mt-6">
                <button
                    type="submit"
                    className="w-full bg-green-500 text-white px-6 py-3 rounded-xl font-bold text-lg hover:bg-green-600 shadow-lg transition"
                >
                    Submit Quiz
                </button>
            </div>
            ...
            {fields.map((field, index) => (
                <div key={field.id} className="flex flex-col gap-1">
                    <div className="flex items-center gap-2">
                        <input
                            {...register(
                                `questions.${nestIndex}.options.${index}.text` as const
                            )}
